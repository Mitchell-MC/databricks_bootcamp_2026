...
The 'first_db_project_git' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/first_db_project_git/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] first_db_project_git_etl` to your workspace.
